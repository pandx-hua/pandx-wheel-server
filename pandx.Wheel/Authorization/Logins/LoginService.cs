...
public class LoginService : ILoginService
{
    ...
    public LoginService(IRepository<LoginAttempt, Guid> loginAttemptRepository, IClientInfoProvider clientInfoProvider, ILogger<AuditingHelper> logger, IUnitOfWork unitOfWork)
    {
    ...
    public async Task CreateLoginAttemptAsync(string userNameOrEmail,LoginResultType loginResultType,Guid? userId=null)
    {
