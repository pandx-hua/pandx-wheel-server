...
{
    //copy from Abp.MimeTypes

    private const string Dot = ".";
    private const string QuestionMark = "?";

    private readonly Lazy<IDictionary<string, string>> MappingDictionary;
    ...
    public string? GetMimeType(string str, bool throwErrorIfNotFound = true)
    {
        if (string.IsNullOrWhiteSpace(str))
        {
            throw new ArgumentNullException(nameof(str));
    ...
    public bool TryGetExtension(string mimeType, out string? extension)
    {
    ...
    public virtual string? GetExtension(string mimeType, bool throwErrorIfNotFound = true)
    {
        ...
        if (TryGetExtension(mimeType, out var extension))
        {
            return extension;
        }
